...
config.iota = {
     ...
     * attributes). This URL will be sent in the Context Registration requests.
	 --------------------------Luu y, cau hinh dia chi IoT Agent
     */
    providerUrl: 'http://172.16.0.4:4061',
